...
public class BayarNovel extends javax.swing.JFrame {
    ...
    public BayarNovel(Novel novel) {
        initComponents();
        juduln.setText("Judul : " + novel.judul);
        authorn.setText("Author : " + novel.author);
        penerbitn.setText("Penerbit : " + novel.penerbit);
        genren.setText("Genre : " + novel.genre);
        halamann.setText(String.valueOf("Halaman :" + novel.halaman));
        stokn.setText(String.valueOf("Stok :" + novel.stok));
        hargan.setText(String.valueOf("Harga :" + novel.harga));
        hargaperharin.setText(String.valueOf("Harga/Hari :" + novel.hargaperhari));
    }
