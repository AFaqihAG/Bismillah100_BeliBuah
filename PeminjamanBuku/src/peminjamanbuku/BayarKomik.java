...
public class BayarKomik extends javax.swing.JFrame {
    private static Komik komikClass;
    ...
    private void buttonBayarkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonBayarkanActionPerforme
        dispose();
        new KonfirmasiPembayaran(komikClass).setVisible(true);
